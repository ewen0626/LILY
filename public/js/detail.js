...
if(getCookie("isLogin")=="user"){
	...
	//alert("管理者你好");
	document.getElementById("signup").href="/logout";
	document.getElementById("signup").innerHTML="登出";
	document.getElementById("login").href="/additem";
	document.getElementById("login").innerHTML="新增商品";
